		...
		<Slide direction="up">
			<Link to={`/user/${data._id}`}>
				<div
					...
					// whileTap={{ scale: 0.9 }}
					className="grid grid-cols-2 text-2xl my-3 max-sm:my-2  bg-opacity-5 bg-white rounded-md gap-5 h-28 overflow-hidden hover:shadow-md items-center pr-5 hover:shadow-slate-800 transition duration-300 ease-in-out">
